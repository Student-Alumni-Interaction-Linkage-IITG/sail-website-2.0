    ...
    return (
      <div class = "about-blog-div">
        ...
        <div className = "about-blog-social">
            <a href='https://www.instagram.com/sail_iitg' target='blank'><img src={insta} alt="Instagram" className="about-insta-icon" /></a>
            <a href='https://www.youtube.com/@IITGuwahatiSAIL' target='blank'><img src={youtube} alt="Youtube" className="about-youtube-icon" /></a>
            <a href='https://www.linkedin.com/company/sail-iitg/' target='blank'><img src={linkedin} alt="LinkedIn" className="about-linkedin-icon" /></a>
            <a href='https://www.facebook.com/sail.iitg/' target='blank'><img src={meta} alt="Messenger" className="about-messenger-icon" /></a>
          </div>
      </div>
