      ...
      <div className="aa-Alumni">
        ...
        <div className="aa-car">
          <div className="aa-car-image1">
            <img src={alum_services} alt="Alumni Services" />
          </div>
            ...
            <div className="aacar-buttons">
              <div className="admit-transcript-container">
                <div className="item">
                  ...
                  <p className="text" onClick={() => window.open('https://iitg.ac.in/acad/alumni/alumni_duplicate_transcript.php', '_blank', 'noopener,noreferrer')}>
                    Get Alumni Card
                  </p>
                </div>
                <div className="item">
                  <img src={transcript} alt="Transcript Icon" className="icon" />
                  <p className="text" onClick={() => window.open('https://online.iitg.ac.in/aerportal/', '_blank', 'noopener,noreferrer')}>
          ...
          <div className="aa-card1">
            <div className="aa-card-content1">
              <div className="aa-card2">
                <h1>Alumni Awards</h1>
                <p>
                  IIT Guwahati has instituted four categories of awards to be given annually to recognize and honor the achievements and contributions of its alumni. The three categories of awards are the Outstanding Service Awards (OSA), Distinguished Alumni Awards (DAA), and Young Alumni Achiever Awards (YAAA).
                </p>
              </div>
              <div className="aa-buttons">
                <button className="aa-buttons-apply" onClick={() => window.open('https://online.iitg.ac.in/aerportal/nomination/', '_blank', 'noopener,noreferrer')}>
                  Apply
                </button>
                <button className="aa-buttons-readmore" onClick={() => window.open('https://www.iitg.ac.in/aer/alumni_award', '_blank', 'noopener,noreferrer')}>
                  Read More
                </button>
              </div>
            </div>
